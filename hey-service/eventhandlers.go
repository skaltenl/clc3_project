...
func HandleInternalGetSLIEvent(myKeptn *keptn.Keptn, incomingEvent cloudevents.Event, data *keptn.InternalGetSLIEventData) error {
	...
	/* if incomingGetSLIEventData.SLIProvider != "hey-service" {
		return nil
	}*/
	...
	// sliConfigFileContent, err := myKeptn.GetKeptnResource("hey-service/sli.yaml")
	...
	// return myKeptn.SendInternalGetSLIDoneEvent(incomingGetSLIEventData, sliResults, labels, err, "hey-service")
